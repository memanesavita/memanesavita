...
#   2. Uske baad hum user se 1 se 10 ke beech mein ek number input lete hai.
#    Phir user humare number ko guess karni ki koshish karta hai.
#    3. Jaise, agar user ne 3 input kiya.
...
# Agar usne 5 chances mein number guess kar liya toh sahi hai,
#  nahi toh ek message aa jayega ki user ne guess nahi kiya.
#  Hint: 
#  Python mein ek break statement hoti hai.
#  Iske baare mein Google kar ke padh lo.
...
while i<=5:
    ...
    if 5==user:
        print("it is a gassing number")
        break
    else:
        print("not gassing number")
    i=i+1
